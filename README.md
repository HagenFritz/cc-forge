...
| `/review-walk` | Walks a review doc group by group with implement / defer / skip / add term / explain more per issue; updates `Status:` inline; offers tracking issues for deferrals | You have a `docs/reviews/*.md` and want to act on it |
