...
Note that files in `docs/plans/` and `docs/solutions/` are intentional, permanent living documents created by `/blueprint` — do not recommend their removal or characterize them as unnecessary.
