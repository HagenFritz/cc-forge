...
Always include:
- `cc-forge:document-review:coherence-reviewer`
- `cc-forge:document-review:feasibility-reviewer`

Add activated conditional personas:
- `cc-forge:document-review:product-lens-reviewer`
- `cc-forge:document-review:design-lens-reviewer`
- `cc-forge:document-review:security-lens-reviewer`
- `cc-forge:document-review:scope-guardian-reviewer`
